function [trialindsout out toes rastcodes] = SM_MC_plotmot(Unit,motifname,ax,sortmethod,passeng,doplot,codemapname)
%[trialindsout out toes rastcodes] = SM_MC_plotmot(Unit,motifname,ax,sortmethod,passeng,doplot)

if nargin < 7;codemapname='defaultshading';end
...
if doplot == 1
    SM_rasttrials(ax,toes,rastcodes,yvals,codemapname);
