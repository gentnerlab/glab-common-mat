function [Units] = SM_reads2mat_20110317(infile,readSpikeShapes,verbose,iscompressedfile)
...
%% Now delimit trials
trialTimeStampTMindsB = find(TM.codes(:,1)==244);                                         %find all trial timestamp TMs
trialTimeStampTMinds = trialTimeStampTMindsB(1:2:end-1);
