function Units = SM_readlib20110328_st421(subject,keepspikeshapes,dataonIbon,verbose,noProcess,noGetSortQual)
...
for currS2Mat=1:nums2mats
    ...
    if isempty(strfind(currS2MatName,'compressed'))
        ...
        Units = [Units SM_reads2mat_20110328_st421(currS2MatName,keepspikeshapes,verbose,iscompressed)];
end
