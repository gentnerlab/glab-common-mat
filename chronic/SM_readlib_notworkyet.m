function Units = SM_readlib_notworkyet(subject,keepspikeshapes,dataonIbon,verbose,noProcess,noGetSortQual)
...
for currS2Mat=1:nums2mats
    ...
    if isempty(strfind(currS2MatName,'compressed'))
        ...
        Units = [Units SM_reads2mat_20110317_notworkyet(currS2MatName,keepspikeshapes,verbose,iscompressed)];
end
