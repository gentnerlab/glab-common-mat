function SM_MC_plotmots2(Unit,ax,sortmethod,passeng)
...
for plotnum = 1:totnummots
    ...
    inds{plotnum} = SM_MC_plotmot(Unit,plotnum,subaxis(nrows,ncols,plotnum),sortmethod,passeng);
     if ~(plotnum > totnummots-ncols)
        set(gca,'xticklabel',[]);
     end
