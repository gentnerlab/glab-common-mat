function [psth,xbins,ymax] = SM_psthtrials(desTrials,varargin)
...
if doerr == 1
    [psth xbins psthC] = SM_getpsth2(desTrials,start,stop,binsize,zeroreference);
else
    [psth xbins] = SM_getpsth2(desTrials,start,stop,binsize,zeroreference);
end
