function [psth,xbins,ymax] = SM_plot_psth_motif(desTrials,varargin)
...
if doerr == 1
    [psth xbins psthC] = SM_getpsth_motif(desTrials,start,stop,binsize,zeroreference);
else
    [psth xbins] = SM_getpsth_motif(desTrials,start,stop,binsize,zeroreference);
end
