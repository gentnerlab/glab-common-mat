function [Units] = SM_reads2mat_20101222_notworkyet(infile,readSpikeShapes,verbose,iscompressedfile)
...
for trialnum = 1:size(stimstartinds,1)
   ...
   if iscompressedfile == 1
       startOffset = DM.times(trialstartinds(trialnum))-DM.times(stimstartinds(trialnum));
    else
    if trialnum == 1
